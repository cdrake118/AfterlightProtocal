...
function drawProximityWarning(agent) {
  ...
  ctx.globalAlpha = critical ? 0.28 : 0.2;
  ctx.strokeStyle = critical ? "#e76f8a" : "#f4b35d";
  ctx.lineWidth = 2;
  ctx.beginPath();
  ctx.arc(agent.x, y, critical ? 18 + pulse * 3 : 15 + pulse * 2, 0, Math.PI * 2);
  ctx.stroke();
  ctx.globalAlpha = critical ? 0.78 : 0.62;
  ctx.fillStyle = critical ? "rgba(231, 111, 138, 0.78)" : "rgba(244, 179, 93, 0.72)";
  ctx.strokeStyle = "#f8fbfd";
  ctx.lineWidth = 1.8;
  ctx.beginPath();
