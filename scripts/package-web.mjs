...
const requiredFiles = [
  ...
  "assets/characters/atlas-example.json",
  "assets/maps/manor-party.game-map.json",
  "assets/maps/manor-party.tiled.json",
  "assets/characters/anomaly-ghost-atlas.png",
  "assets/characters/investigator-brown-atlas.png",
  "assets/characters/investigator-blond-atlas.png",
  "assets/characters/investigator-black-atlas.png",
  "assets/characters/investigator-red-atlas.png",
  "README.md",
